...
train_pipeline = [
    ...
    dict(
        ...
        keys=[
            'veh2inf_rt', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_inds', 'img',
            ...
            'gt_lane_masks', 'gt_segmentation', 'gt_instance', 'gt_centerness',
            'gt_offset', 'gt_flow', 'gt_backward_flow',
            'gt_occ_has_invalid_frame', 'gt_occ_img_is_valid',
            'gt_future_boxes', 'gt_future_labels', 'sdc_planning',
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'sample_idx_inf', 'prev_idx', 'next_idx',
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                type='CustomCollect3D',
                keys=[
                    'veh2inf_rt', 'img', 'timestamp', 'l2g_r_mat', 'l2g_t',
                ...
                meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                           ...
                           'pcd_trans', 'sample_idx', 'sample_idx_inf',
                           'prev_idx', 'next_idx', 'pcd_scale_factor',
...
data = dict(
    ...
    train=dict(
        ...
        data_root='datasets/V2X-Seq-SPD-New/cooperative/',
        ann_file=
        'data/infos/V2X-Seq-SPD-New/cooperative/spd_infos_temporal_train.pkl',
        pipeline=[
            dict(
                type='LoadMultiViewImageFromFilesInCeph',
                to_float32=True,
            ...
            dict(
                type='CustomCollect3D',
                keys=[
                    'veh2inf_rt', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_inds',
                    'img', 'timestamp', 'l2g_r_mat', 'l2g_t', 'gt_fut_traj',
                    'gt_fut_traj_mask', 'gt_past_traj', 'gt_past_traj_mask',
                    'gt_sdc_bbox', 'gt_sdc_label', 'gt_sdc_fut_traj',
                    'gt_sdc_fut_traj_mask', 'gt_lane_labels', 'gt_lane_bboxes',
    ...
    val=dict(
        ...
        data_root='datasets/V2X-Seq-SPD-New/cooperative/',
        ann_file=
        'data/infos/V2X-Seq-SPD-New/cooperative/spd_infos_temporal_val.pkl',
        pipeline=[
            dict(
                type='LoadMultiViewImageFromFilesInCeph',
                to_float32=True,
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        type='CustomCollect3D',
                        keys=[
                            'veh2inf_rt', 'img', 'timestamp', 'l2g_r_mat',
                            'l2g_t', 'gt_lane_labels', 'gt_lane_bboxes',
                            'gt_lane_masks', 'gt_segmentation', 'gt_instance',
                            'gt_centerness', 'gt_offset', 'gt_flow',
                            'gt_backward_flow', 'gt_occ_has_invalid_frame',
...
log_level = 'INFO'
work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_coop_e2e_compA_ft'
load_from = 'ckpts/univ2x_coop_e2e_stg2.pth'
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_coop_e2e/epoch_3.pth'
workflow = [('train', 1)]
plugin = True
...
model_other_agent_inf = dict(
    ...
    num_classes=10,
    vehicle_id_list=[0, 1, 2, 3, 4, 6, 7],
    pc_range=[0, -51.2, -5.0, 102.4, 51.2, 3.0],
...
ann_file_train = 'data/infos/V2X-Seq-SPD-New/cooperative/spd_infos_temporal_train.pkl'
ann_file_val = 'data/infos/V2X-Seq-SPD-New/cooperative/spd_infos_temporal_val.pkl'
ann_file_test = 'data/infos/V2X-Seq-SPD-New/cooperative/spd_infos_temporal_val.pkl'
split_datas_file = './data/split_datas/cooperative-split-data-spd.json'
v2x_side = 'cooperative'
eval_mod = ['det', 'map', 'track', 'motion']
optimizer = dict(
