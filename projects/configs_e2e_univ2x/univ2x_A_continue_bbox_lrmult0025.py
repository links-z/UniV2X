...
work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_A_continue_bbox_lrmult005'
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=15,
    filename_tmpl='A_bbox_lrmult005_iter_{}.pth'
)
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # 需要训练的部分
            'cross_agent_query_interaction': dict(lr_mult=0.05),  # 5e-5 × 0.05 = 2.5e-6
            'pts_bbox_head': dict(lr_mult=0.025),  # 5e-5 × 0.03 = 1.5e-6
        }
    )
)