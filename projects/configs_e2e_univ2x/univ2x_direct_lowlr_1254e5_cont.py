...
load_from = None
resume_from = 'projects/work_dirs_e2e_univ2x/univ2x_direct_lowlr_1254e5/direct_lowlr_iter_300.pth'
auto_resume = False

work_dir = 'projects/work_dirs_e2e_univ2x/univ2x_direct_lowlr_1254e5_cont'

data = dict(workers_per_gpu=4)

# 从 direct_lowlr_iter_300.pth 继续往后训练
# max_epochs 必须大于 checkpoint 已经记录的 epoch
total_epochs = 2
...
checkpoint_config = dict(
    ...
    interval=100,
    max_keep_ckpts=20,
    filename_tmpl='direct_lowlr_cont_iter_{}.pth'
)
